...
if (isset($_POST['login'])) {
    ...
    if ($coordinates) {
        ...
        $error_message = "L'adresse saisie n'est pas valide";
    }
}
?>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-sm navbar-light" id="neubar">
    ...
    <div class="titre">
        <section id="rechercher">
          <h3><b>Ajoutez un festival ici</b></h3>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="adresse" class="form-control" id="exampleFormControlInput1" placeholder="Entrez l'adresse de votre festival" required autocomplete="off">
    </div>
    <div class="mb-3">
